...
if __name__ == "__main__":
    ...
    num_threads = int(input("Pls fucking put threads or i gonna fuck your mom: ")) # You can set the number of threads here
    run_threads(num_threads)
input('all nigga combos order history checked press enter to exit.....')